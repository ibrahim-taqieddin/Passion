...
@section('content')
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="row align-items-center" data-aos="flip-left" data-aos-easing="ease-out-cubic"
                ...
                <div class="col-lg-7">
                    <div class="text-left mb-4">
                        ...
                        <h1>Age Is Precious, Catch Your Life Early</h1>
                    </div>
                    <p><b>
    ...
    <!-- Category Start -->
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">
    ...
    <div class="container-fluid bg-registration py-5" style="margin: 90px 0;">
        <div class="container py-5">
            <div class="row align-items-center" data-aos="zoom-in-down">
    ...
    <!-- Team Start -->
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3" data-aos="flip-up" data-aos-duration="2000">
            <div class="text-center mb-5">
